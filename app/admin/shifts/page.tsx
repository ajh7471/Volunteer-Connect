      ...
      <DialogContent className="sm:max-w-xl max-h-[90vh] flex flex-col p-0">
        ...
        <ScrollArea className="flex-1">
          <div className="p-6 space-y-6">
              ...
              <div className="grid grid-cols-2 gap-2">
                {RECURRENCE_PATTERNS.map((p) => (
                  ...
                  >
                    <div className="flex items-center gap-2">
                      {p.value === "none" ? (
                        <CalendarSimple className="h-4 w-4 text-muted-foreground" />
                      ) : (
            ...
            <div className="space-y-3">
              ...
              <div className="grid grid-cols-3 gap-2">
                {SLOTS.map((s) => (
                  ...
                  >
                    <div className="font-semibold">{SLOT_DEFAULTS[s].label}</div>
            ...
            {/* Capacity */}
            <div className="space-y-2">
              <Label className="text-base font-semibold">Volunteer Capacity</Label>
              <Input
                type="number"
                min={1}
                max={50}
              ...
              />
              <p className="text-sm text-muted-foreground">Maximum volunteers per shift</p>
            </div>
        ...
        {/* Footer */}
        <div className="p-6 pt-4 border-t shrink-0 flex gap-3 bg-background">
          <Button variant="outline" onClick={onClose} className="flex-1 h-12">
            Cancel
          </Button>
          <Button onClick={handleCreate} disabled={isPending} className="flex-1 h-12">
            {isPending ? (
